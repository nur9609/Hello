...
1. Чтобы скачать проект, запускаем команду:
	git clone https://github.com/nur9609/homework.git
2. Чтобы запустить сервер, перейдите в папку homework/Mybatis:
	cd homework/Mybatis
...
запускаем команду, переходим в папку homework/client: 
	cd homework/client
